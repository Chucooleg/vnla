...
# command="python -u -m pdb -c continue train_semantics.py -exp $exp_name -job $job_name -config $config_file $extras"
command="python train_semantics.py -exp $exp_name -job $job_name -config $config_file $extras"
